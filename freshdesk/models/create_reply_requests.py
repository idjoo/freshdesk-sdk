...
T = TypeVar("T", bound="CreateReplyRequests")


@_attrs_define
class CreateReplyRequests:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: dict[str, Any]) -> T:
        ...
        create_reply_requests.additional_properties = d
        return create_reply_requests
